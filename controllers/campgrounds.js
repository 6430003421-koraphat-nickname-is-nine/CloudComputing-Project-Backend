...
exports.createCampground = async (req, res, next) => {
  ...
  try {
    ...
    console.log(err);
    res.status(400).json({ success: false, message: err.code=='11000'? 'Campground name must be unique.': "Cannot create campground." });
  }
};
...
exports.updateCampground = async (req, res, next) => {
  ...
  try {
    ...
    res.status(400).json({ success: false , message: error.codeName=='DuplicateKey'? 'Campground name must be unique.': "Cannot update campground." });
  }
};
